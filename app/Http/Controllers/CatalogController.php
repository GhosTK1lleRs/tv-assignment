...
class CatalogController extends Controller
{
    public function index()
    {
        ...
        $user  = Auth::user();
        $catalogs = Catalog::latest()->where('user_id', '=', $user->id)->paginate(30);
        $uploads = Upload::orderBy('name', 'ASC')->where('user_id', '=', $user->id)->paginate(30);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            response()->json(array('success' => true, 'last_insert_id' => $catalogData->id), 200);
            ...
            return redirect()->route('catalog.show', $catalog_id)
    ...
    public function destroy($id)
    {
        ...
        DB::table('catalog_uploads')->where('catalog_id', '=', $id)->delete();
        return redirect()->route('catalog.index')
